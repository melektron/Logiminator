  ...
  m_Button_Close("Close")
{
  ...
  //completion->set_match_func( sigc::mem_fun(*this,
              //&EntryExample::on_completion_match) );
  ...
  completion->signal_action_activated().connect( sigc::mem_fun(*this,
              &EntryExample::on_completion_action_activated) );
 ...
 *
bool EntryExample::on_completion_match(const Glib::ustring& key, const
...
void EntryExample::on_completion_action_activated(int index)
{
